...
def initial_state(): #available in runner.py
    """
...
def player(board): #available in runner.py
    """
...
def result(board, action): #available in runner.py
    """
...
def winner(board): #available in runner.py
    """
...
def terminal(board): #available in runner.py
    """
...
def minimax(board): #available in runner.py
    """
